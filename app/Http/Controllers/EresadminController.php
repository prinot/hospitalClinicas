...
class EresadminController extends Controller
{
    ...
    {
        $page_title = 'Ejercicios Previos y Calentamiento';
        $page_description = 'Ejercicios Previos y Calentamiento';
    ...
    public function ejercicio_wejercicio()
    {
        $page_title = 'Ejercicios Previos y Calentamiento';
        $page_description = 'Ejercicios Previos y Calentamiento';
        ...
        return view('ejercicio.wejercicio', compact('page_title', 'page_description','action'));
    }

    public function ejercicio_wejercicio4()
    {
        $page_title = 'Ejercicios Previos y Calentamiento';
        $page_description = 'Ejercicios Previos y Calentamiento';
